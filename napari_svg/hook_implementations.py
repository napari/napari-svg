...
supported_layers = ['image', 'points', 'labels']
...
def napari_write_labels(path, data, meta):
    ...
    path : str
        Path to file, directory, or resource (like a URL).
    data : array or list of array
        Labels data. Only two dimensional data (including pyramid).
        For pyramid data the lowest resolution is used.
    meta : dict
        Labels metadata.
...
def napari_write_vectors(path, data, meta):
    ...
    path : str
        Path to file, directory, or resource (like a URL).
    data : array
        Vectors data. Only two dimensional data.
    meta : dict
        Vectors metadata.
